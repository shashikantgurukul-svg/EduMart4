...
function Home() {
      ...
      <div className="min-h-screen text-white container mx-auto">
        ...
        <section className="text-center py-20">
          ...
          <div className="space-x-4 mt-8">
            ...
            <Link
              to={"https://www.youtube.com/channel/UC34M1GmIjxAEtR2bLmVZE3A"}
          ...
          <Slider className="" {...settings}>
            {courses.map((course) => (
              <div key={course._id} className="p-4">
                <div className="relative flex-shrink-0 w-100 transition-transform duration-300 transform hover:scale-105">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div className="p-6 bg-gray-900 rounded-lg">
      ...
      <p className="text-gray-400">High quality courses at low price</p>
    </div>

    <div className="p-6 bg-gray-900 rounded-lg">
      <h3 className="text-xl font-semibold mb-2">Lifetime Access</h3>
      <p className="text-gray-400">Access anytime, anywhere</p>
    </div>
  </div>
</section>
        {/* Footer */}
